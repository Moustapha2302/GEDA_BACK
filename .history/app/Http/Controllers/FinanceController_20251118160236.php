...
class FinanceController extends Controller
{
    ...
    {
        try {
            Log::info('Tentative création document financier', [
                'user_id' => auth()->id(),
                'data' => $request->all()
            ]);
            ...
            Log::info('Document financier créé avec succès', ['document_id' => $document->id]);
            ...
            Log::error('Erreur création document financier', ['error' => $e->getMessage()]);
