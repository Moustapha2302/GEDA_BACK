...
use Illuminate\Foundation\Auth\Access\AuthorizesRequests; // ← OBLIGATOIRE

class EtatCivilController extends Controller
{
    use AuthorizesRequests; // ← AJOUTÉ : résout l'erreur "Call to unknown method authorize()"

    public function __construct()
    {
        $this->middleware('auth:sanctum'); // Sanctum uniquement
    }
    ...
    public function certificat($type)
    {
        ...
        // Ici tu mettras DomPDF plus tard
