...
{
    // ❌ NE PAS METTRE DE __construct() ICI
    // Le middleware est géré dans routes/api.php
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($user->service_id != 1) {
                return response()->json([
                    'message' => 'Accès refusé. Seul le service État Civil peut créer des actes.',
                    'your_service' => $user->service_id
                ], 403);
            }
