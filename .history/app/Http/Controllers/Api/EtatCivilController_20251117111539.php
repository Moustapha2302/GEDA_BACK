...
use App\Http\Controllers\Controller;  // ← LIGNE OUBLIÉE (c’est celle-là qui manquait !)
use App\Models\Acte;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;

class EtatCivilController extends Controller   // ← extends Controller (pas Controller tout court)
{
    public function index()
    {
        $this->authorize('viewAny', ActeEtatCivil::class);   // ← maintenant ça marche !
    ...
    public function certificat($type)
    {
        ...
        return response()->json(['message' => "Certificat de {$type} généré (simulation)"]);
    }
